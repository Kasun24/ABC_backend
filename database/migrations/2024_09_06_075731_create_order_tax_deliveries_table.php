...
class CreateOrderTaxDeliveriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_tax_deliveries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('order_tax_deliveries');
    }
}
